...
define void @__nvqpp__mlirgen__function_cz_swap._Z7cz_swapv() local_unnamed_addr #0 {
"0":
  ...
  tail call void @__quantum__qis__cnot__body(ptr null, ptr nonnull inttoptr (i64 2 to ptr))
  tail call void @__quantum__qis__h__body(ptr nonnull inttoptr (i64 2 to ptr))
  tail call void @__quantum__qis__swap__body(ptr nonnull inttoptr (i64 1 to ptr), ptr nonnull inttoptr (i64 2 to ptr))
...
declare void @__quantum__qis__swap__body(ptr, ptr) local_unnamed_addr
