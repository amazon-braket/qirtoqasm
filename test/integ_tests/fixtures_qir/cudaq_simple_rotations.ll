...
define void @__nvqpp__mlirgen__k..0x112b8ac90() #0 {
  call void @__quantum__qis__rx__body(double 1.000000e-01, %Qubit* null)
  call void @__quantum__qis__ry__body(double 2.000000e-01, %Qubit* inttoptr (i64 1 to %Qubit*))
