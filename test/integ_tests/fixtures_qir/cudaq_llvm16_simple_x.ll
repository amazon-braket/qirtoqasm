; Exact QIR text produced by CUDA-Q's qir-adaptive codegen (LLVM 16)
; for a single-qubit `x; mz` kernel. Used to test that qirtoqasm accepts
; LLVM 15+ textual-form artifacts: quoted numeric block labels (`"0":`)
; and opaque-ptr operands throughout.
...
define void @__nvqpp__mlirgen__simple_x() local_unnamed_addr #0 {
"0":
