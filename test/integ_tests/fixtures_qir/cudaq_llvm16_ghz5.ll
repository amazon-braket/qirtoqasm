...
define void @__nvqpp__mlirgen__function_ghz_5._Z5ghz_5v() local_unnamed_addr #0 {
"0":
  ...
  tail call void @__quantum__qis__cnot__body(ptr nonnull inttoptr (i64 2 to ptr), ptr nonnull inttoptr (i64 3 to ptr))
  tail call void @__quantum__qis__cnot__body(ptr nonnull inttoptr (i64 3 to ptr), ptr nonnull inttoptr (i64 4 to ptr))
  tail call void @__quantum__qis__mz__body(ptr null, ptr writeonly null)
  tail call void @__quantum__rt__array_record_output(i64 5, ptr nonnull @cstr.61727261793C6931207820353E00)
  ...
  tail call void @__quantum__rt__result_record_output(ptr nonnull inttoptr (i64 3 to ptr), ptr nonnull @cstr.72303030303300)
  %3 = tail call i1 @__quantum__qis__read_result__body(ptr nonnull inttoptr (i64 3 to ptr))
  tail call void @__quantum__qis__mz__body(ptr nonnull inttoptr (i64 4 to ptr), ptr nonnull writeonly inttoptr (i64 4 to ptr))
  tail call void @__quantum__rt__result_record_output(ptr nonnull inttoptr (i64 4 to ptr), ptr nonnull @cstr.72303030303400)
  %4 = tail call i1 @__quantum__qis__read_result__body(ptr nonnull inttoptr (i64 4 to ptr))
  ret void
}
